...
Route::get('/rollend/export', 'Vehicles\VehicleFormController@export')->name('export-vehicles');
...
Route::post('/rollend/toevoegen', 'Vehicles\VehicleFormController@add_vehicle')->name('add_vehicle');
Route::post('/rollend/bijwerken/{id}', 'Vehicles\VehicleFormController@edit');
Route::post('/rollend/verwijder/{id}', 'Vehicles\VehicleFormController@delete');
Route::post('/rollend/comment/add/{id}', 'Vehicles\VehicleFormController@add_comment');
Route::post('/rollend/img/toevoegen/{id}', 'Vehicles\VehicleFormController@upload_img');
Route::post('/rollend/exam/toevoegen/{id}', 'Vehicles\VehicleFormController@upload_exam');
Route::post('/rollend/doc/toevoegen/{id}', 'Vehicles\VehicleFormController@upload_doc');
Route::post('/rollend/prop/toevoegen/{id}', 'Vehicles\VehicleFormController@add_prop');
