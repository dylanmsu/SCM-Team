    ...
    data() {
        return {
            ...
            icons: [
                ...
                { icon: 'INT', color: 'color: red', index: 6 },
                { icon: 'T', color: 'color: white', index: 7 },
                { icon: 'STOOM', color: 'color: white', index: 8 },
                { icon: 'DIESEL', color: 'color: white', index: 9 },
                { icon: 'MOTORWAGEN', color: 'color: white', index: 10 },
                { icon: 'GROEP', color: 'color: white', index: 11 },
                { icon: 'SINT', color: 'color: red', index: 12 },
                { icon: 'EVENT', color: 'color: white', index: 13 },
                { icon: 'DINING', color: 'color: white', index: 14 },
